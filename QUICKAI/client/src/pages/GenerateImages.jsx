...
const GenerateImages = () => {
  ...
  return (
    <div className='h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700'>
      {/*left col*/ }
      <form onSubmit={onSubmitHandler} className='flex-1 min-w-[300px] p-4 bg-white rounded-lg border border-gray-200'>
        ...
        placeholder='Describe what you want in the image..' required/>
        ...
        <div className='my-6 flex items-center gap-2'>
          <label className='relative cursor-pointer inline-block'>
            ...
            <span className='absolute left-1 top-1 w-3 h-3 bg-white rounded-full transition-transform transform peer-checked:translate-x-4'></span>
          </label>
      ...
      <div className='flex-1 min-w-[300px] p-4 bg-white rounded-lg flex flex-col border border-gray-200 min-h-96'>
        ...
        <div className='flex items-center gap-3'>
          <Image className='w-5 h-5 text-[#00AD@%]'/>
